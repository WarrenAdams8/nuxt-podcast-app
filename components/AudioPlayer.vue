      ...
      <div class="flex items-start lg:items-center">
        ...
        <div class="flex-1 flex flex-col items-center">
          ...
          <div class="w-full max-w-2xl px-6 mb-3">
            <USlider v-model="sliderValue" :min="0" :max="duration" :step="0.1"
          ...
          <div class="flex items-center justify-center space-x-6">
            <UButton color="white" variant="ghost" @click="store.skipBackward">
            ...
            <UButton color="white" variant="ghost" @click="store.skipForward">
              <div class="flex items-center text-sm">
                15
